...
client features with C Tor.  The last big security feature needed for Tor
Hidden Services aka `.onion` services (resistance to out-of-memory DoS)
landed in this release.  And, in Arti client 1.3.0, connecting to `.onion`
domains is enabled by default.
