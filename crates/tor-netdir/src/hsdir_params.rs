...
mod test {
    ...
    use super::*;
    use hex_literal::hex;
    use tor_netdoc::doc::netstatus::{MdConsensusBuilder, Lifetime, MdConsensusRouterStatus};
    ...
    fn example_consensus_builder() -> MdConsensusBuilder<MdConsensusRouterStatus> {
